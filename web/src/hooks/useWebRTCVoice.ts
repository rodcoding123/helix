/**
 * WebRTC Voice Conversation Hook
...
/**
 * Hook for managing WebRTC voice conversations
 */
export function useWebRTCVoice(
  ...
  const startConversation = useCallback(async () => {
    try {
      ...
      const ws = new WebSocket(`${wsUrl}/voice/webrtc`);
  ...
  }, [initializePeerConnection, gatewayUrl]);
