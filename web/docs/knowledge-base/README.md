...
Complete user documentation for all Helix features.
...
Use the **Help** menu in the sidebar to access this knowledge base anytime.
...
4. [Finding Templates](./extended/agent-templates.md#finding-templates)
...
- [Marketplace FAQ](./extended/marketplace.md#troubleshooting)

## Contributing

Found an issue in the documentation? Have a suggestion?

Please report it at: [GitHub Issues](https://github.com/anthropics/helix/issues)
...
**Need help?** Click the **?** icon in the sidebar to open this knowledge base.
