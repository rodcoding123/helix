...
export function formatStatusSummary(summary) {
    ...
    if (!summary.linkChannel) {
        ...
        const authAge = linked && typeof summary.linkChannel.authAgeMs === "number"
    ...
    const defaultCtx = typeof defaults?.contextTokens === "number"
...
//# sourceMappingURL=tui-status-summary.js.map