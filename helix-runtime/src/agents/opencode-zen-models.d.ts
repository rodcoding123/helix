...
export declare const OPENCODE_ZEN_DEFAULT_MODEL = "claude-opus-4-5";
export declare const OPENCODE_ZEN_DEFAULT_MODEL_REF = "opencode/claude-opus-4-5";
/**
...
//# sourceMappingURL=opencode-zen-models.d.ts.map