...
export declare function createSandboxedReadTool(root: string): AnyAgentTool;
export declare function createSandboxedWriteTool(root: string): AnyAgentTool;
export declare function createSandboxedEditTool(root: string): AnyAgentTool;
export declare function createOpenClawReadTool(base: AnyAgentTool): AnyAgentTool;
export {};
//# sourceMappingURL=pi-tools.read.d.ts.map