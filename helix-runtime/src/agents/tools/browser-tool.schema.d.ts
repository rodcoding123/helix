export declare const BrowserToolSchema: import("@sinclair/typebox").TObject<{
    action: import("@sinclair/typebox").TUnsafe<"status" | "open" | "close" | "start" | "console" | "profiles" | "snapshot" | "stop" | "navigate" | "upload" | "dialog" | "pdf" | "screenshot" | "tabs" | "focus" | "act">;
...
//# sourceMappingURL=browser-tool.schema.d.ts.map