...
export function resolveUserTimezone(configured) {
...
export function resolveUserTimeFormat(preference) {
...
export function withNormalizedTimestamp(value, rawTimestamp) {
...
function detectSystemTimeFormat() {
    ...
    if (process.platform === "win32") {
        try {
            const result = execSync('powershell -Command "(Get-Culture).DateTimeFormat.ShortTimePattern"', { encoding: "utf8", timeout: 1000 }).trim();
...
export function formatUserTime(date, timeZone, format) {
