...
export declare function setCloudflareAiGatewayConfig(accountId: string, gatewayId: string, apiKey: string, agentDir?: string): Promise<void>;
...
//# sourceMappingURL=onboard-auth.credentials.d.ts.map