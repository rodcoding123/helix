...
export declare const ConnectParamsSchema: import("@sinclair/typebox").TObject<{
    ...
    client: import("@sinclair/typebox").TObject<{
        id: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"test" | "cli" | "webchat-ui" | "openclaw-control-ui" | "webchat" | "gateway-client" | "openclaw-macos" | "openclaw-ios" | "openclaw-android" | "node-host" | "fingerprint" | "openclaw-probe">[]>;
        ...
        mode: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"test" | "node" | "cli" | "webchat" | "ui" | "backend" | "probe">[]>;
