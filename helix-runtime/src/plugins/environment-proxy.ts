 ...
 */
export function createPluginEnvironment(pluginId: string): Record<string, string> {
  return new Proxy({}, {
    get(target: any, prop: string | symbol): string | undefined {
 ...
 */
function logPluginSecretAccess(pluginId: string, variableName: string): void {
 ...
 */
export function getAllowedEnvironmentVariables(): string[] {
 ...
 */
export function verifySensitiveVariableBlocked(env: Record<string, string>, variableName: string): boolean {
