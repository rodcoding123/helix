...
function getSessionRecipients(cfg) {
    ...
    const recipients = Object.entries(store)
        ...
        .map(([_, entry]) => ({
        to: normalizeChatChannelId(entry?.lastChannel) === "whatsapp" && entry?.lastTo
...
export function resolveWhatsAppHeartbeatRecipients(cfg, opts = {}) {
    if (opts.to) {
...
//# sourceMappingURL=whatsapp-heartbeat.js.map