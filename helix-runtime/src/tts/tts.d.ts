...
export declare const OPENAI_TTS_VOICES: readonly ["alloy", "ash", "coral", "echo", "fable", "onyx", "nova", "sage", "shimmer"];
...
export declare const _test: {
    ...
    OPENAI_TTS_VOICES: readonly ["alloy", "ash", "coral", "echo", "fable", "onyx", "nova", "sage", "shimmer"];
