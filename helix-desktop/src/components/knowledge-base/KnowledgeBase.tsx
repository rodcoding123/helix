...
const GUIDES: KnowledgeBaseGuide[] = [
  ...
  },
  {
    ...
    category: 'extended',
    path: 'extended/skill-composition',
  ...
  },
  {
    ...
    category: 'extended',
    path: 'extended/memory-synthesis',
...
export const KnowledgeBase: FC = () => {
  ...
  useEffect(() => {
    if (activeGuide) {
      setIsLoading(true);
      // In production, this would fetch from your knowledge-base folder
