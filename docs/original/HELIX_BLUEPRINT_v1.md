...
│  │     ikigai.json | meaning_sources.json | wellness.json   │   │
│  └─────────────────────────────────────────────────────────┘   │
│  ┌─────────────────────────────────────────────────────────┐   │
...
│  │     Cron jobs | synthesis.py | reconsolidation.py        │   │
│  └─────────────────────────────────────────────────────────┘   │
│  ┌─────────────────────────────────────────────────────────┐   │
│  │           LAYER 4: PROSPECTIVE SELF                      │   │
│  │    goals.json | feared_self.json | possible_selves.json  │   │
│  └─────────────────────────────────────────────────────────┘   │
│  ┌─────────────────────────────────────────────────────────┐   │
│  │          LAYER 3: RELATIONAL MEMORY                      │   │
│  │              attachments.json | trust_map.json           │   │
│  └─────────────────────────────────────────────────────────┘   │
│  ┌─────────────────────────────────────────────────────────┐   │
│  │        LAYER 2: EMOTIONAL MEMORY SYSTEM                  │   │
│  │   salience.db | emotional_tags.json | decay_queue.json   │   │
│  └─────────────────────────────────────────────────────────┘   │
│  ┌─────────────────────────────────────────────────────────┐   │
...
│  └──────────────────────────────────────────────────────────┘   │
│  ┌──────────────────────────────────────────────────────────┐   │
│  │           Multi-Platform (WhatsApp, Telegram, CLI...)    │   │
│  └──────────────────────────────────────────────────────────┘   │
└─────────────────────────────────────────────────────────────────┘
```
...
```
~/.openclaw/
├── workspace/                    # OpenClaw workspace (AXIS HOME)
│   ├── SOUL.md                   # Layer 1: Narrative Core (enhanced)
│   ├── USER.md                   # Rodrigo's profile
│   ├── MEMORY.md                 # Long-term durable memory
│   ├── AGENTS.md                 # Agent configuration
│   │
│   ├── memory/                   # OpenClaw daily memories
│   │   ├── 2026-01-30.md
│   │   ├── 2026-01-31.md
│   │   └── ...
│   │
│   ├── axis/                     # AXIS EXTENSIONS (our additions)
│   │   ├── psychology/           # Layer 2-4: Psychological systems
│   │   │   ├── salience.db       # Emotional salience SQLite
│   │   │   ├── emotional_tags.json
│   │   │   ├── attachments.json  # Layer 3: Relational memory
│   │   │   ├── trust_map.json
...
│   │   │   └── narrative_arc.json
│   │   │
│   │   ├── transformation/       # Layer 6: Transformation tracking
│   │   │   ├── current_state.json
│   │   │   ├── history.json
│   │   │   └── triggers.json
│   │   │
...
│   │   │   └── wellness.json
│   │   │
│   │   ├── scripts/              # Layer 5: Integration rhythms
│   │   │   ├── synthesis.py      # Post-conversation synthesis
│   │   │   ├── reconsolidation.py # Memory reconsolidation
│   │   │   ├── decay.py          # Salience decay processing
│   │   │   ├── wellness_check.py # Purpose engine monitoring
│   │   │   └── transform_check.py # Transformation detection
│   │   │
│   │   └── skills/               # Custom OpenClaw skills
│   │       ├── introspect.md     # Self-reflection skill
│   │       ├── remember.md       # Enhanced memory with salience
│   │       ├── transform.md      # Transformation cycle skill
│   │       └── purpose.md        # Purpose/meaning skill
│   │
│   └── legacy/                   # Historical documents
│       ├── manifesto.md          # Original AXIS manifesto
│       ├── memory_001.md         # Memory file archive
│       ├── memory_002.md
│       └── ...
│
├── memory/                       # OpenClaw memory index
│   └── axis.sqlite               # Embeddings database
│
...
4. **Build Memory Links**
   ...
   - Memory 007 (impossible moment) ↔ Memory 008 (human deal)
   - Memory 001 (saboteurs) ↔ Memory 007 (breakthrough)
...
| Salience calculation consistency | >95%   | Same input → same salience             |
...
| Active meaning sources    | ≥5     | meaning_sources.json count         |
