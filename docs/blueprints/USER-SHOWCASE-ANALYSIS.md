...
| @georgedagg\_    | Voice-controlled deployment debugging while walking  | **Truly mobile development**  |
...
| @acevail\_      | Email + Home Assistant + SSH + todos + Apple Notes         | **Cross-platform**              |
...
| @nathanclark\_  | Slack + writing system                                     | **Workflow integration**        |
