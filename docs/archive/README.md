...
This folder contains historical documentation and planning documents that are no longer active but preserved for reference.
...
- **Development Setup**: See root docs like `HELIX_TECHNICAL_SPEC.md`

## When to Use Archive

✓ Use for: Understanding historical context, tracing design decisions, project archaeology
✗ Don't use for: Current implementation, deployment, or user guidance
...
For active project files, see parent directory structure.
